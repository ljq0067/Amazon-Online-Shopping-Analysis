...
### Loop through files in corpus to build file list and collect
### all articles' vectorized word counts into single data frame.
for name in ["Fashion", "Kindle"]:
    path = "D:/Jieqian Liu/Data Science and Analystics/ANLY501 Data Science & Analytics/Individual Project Profolio/naive bayes/discussion/" + name
    FileList=[]
...
ax.xaxis.set_ticklabels(['Kindle', 'Fashion'])
ax.yaxis.set_ticklabels(['Kindle', 'Fashion']);
plt.show()
